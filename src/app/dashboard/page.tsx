    ...
    <div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-8">
        <div className="bg-[#1a1a2e] border border-[#333] rounded-xl p-5">
          ...
          <div className="text-[#888] text-xs mt-1">{proximoCompromisso?.data} às {proximoCompromisso?.hora}</div>
        </div>
      ...
      <div className="bg-[#1a1a2e] border border-[#333] rounded-xl p-5 mb-8">
        ...
        <div className="space-y-3">
          {agenda.map((item) => (
            <div key={item.id} className="flex items-center gap-3 p-3 bg-[#0d0d1a] rounded-lg border-l-3 border-[#ff6b35]">
              <div className="text-sm">
                <span className="text-[#888]">{item.data}</span>
